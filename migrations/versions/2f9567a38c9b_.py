...
Revision ID: 2f9567a38c9b
Revises: 
Create Date: 2024-03-18 18:59:35.562718
...
def upgrade():
    ...
    with op.batch_alter_table('event', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_event_module'), ['module'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('event', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_event_module'))
